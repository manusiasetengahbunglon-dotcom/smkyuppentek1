...
export default function About() {
  return (
    <section
      id="about"
      className="relative py-24 bg-gradient-to-b from-blue-50 to-white text-gray-700"
    >
      {/* Judul Section */}
      <motion.div
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 px-6 text-left"
      >
        {/* VISI */}
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="bg-white/70 backdrop-blur-sm border border-blue-100 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 p-8"
        >
