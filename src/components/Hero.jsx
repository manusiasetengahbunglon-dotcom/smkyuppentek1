...
export default function Hero() {
  ...
  return (
    <>
      ...
      <section
        id="hero"
        className="relative w-full min-h-screen flex flex-col justify-center items-center overflow-hidden text-center md:text-left md:items-start px-6 md:px-16"
        style={{
      ...
      >
        ...
        <div
          className="
            relative z-10 text-white max-w-3xl animate-fadeIn
        ...
        >
          ...
          <p className="text-gray-100/90 text-sm sm:text-base md:text-lg mb-8 leading-relaxed max-w-2xl text-center md:text-left">
